                ...
                <form action="">
                    <div class="relative mb-3" data-te-input-wrapper-init>
                        ...
                        <label for="exampleFormControlInput1"
                            class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none">Enter
                            Party result
                        </label>
                    </div>
                    <div class="mb-3" t>
                    ...
                    <div class="mb-3" t>
                        <select name="unit" data-te-select-init>
                            ...
                            <?php foreach ($polling_units as $poling_unit) : ?>
                            <option value="<?= $polling_unit->polling_unit_id ?>">
                                <?= $polling_unit->polling_unit_name ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </form>
